...
Desenvolvedor Full Stack com as tecnologias Javascript, Node, React, Mongo e Next JS. 🚀
Já apliquei em projetos as tecnologias: (JavaScript, TypeScript, Node, Express, HTML, Styled-Components, Css, Scss, Tailwind, Bootstrap, React.js, API CRUD, Rest API, Mongo, NextJS, Insomnia) Assim como diversos frameworks e bibliotecas, bem como Familia (GIT).
